...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        # self.epsilon = 1 - (0.001 * self.trial)
        self.trial += 1
        self.epsilon = 1.00 / (self.trial * self.trial)
    ...
    def build_state(self):
        ...
        # Collect pythodata about the environment
    ...
    def learn(self, state, action, reward):
        ...
        h = hash(state)
        self.Q[h][action] = (1 - self.alpha) * self.Q[h][action] + self.alpha * reward
